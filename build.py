...
def build():
    ...
    if os.path.exists('dist'):
        ...
        if os.path.exists(guide_html):
            shutil.copy(guide_html, os.path.join(final_output_dir, "USER-GUIDE.html"))
            log_info("Copied USER-GUIDE.html to dist folder")
